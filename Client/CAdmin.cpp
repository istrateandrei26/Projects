...
void CAdmin::Run() {
	...
	do {
		...
		case '3':
			//sterge utilizatord
			AskDeleteUserDetails();
			break;
		case '4':
			//promote suer
			AskPromoteUserDetails();
			break;
		case '5':
			//setari cont
			SwitchSetariCont();
...
void CAdmin::WelcomePrint() {
	...
	std::cout << "\nApasati:";
	std::cout << "\n\t1. Vizualizare lista utilizatori";
	std::cout << "\n\t2. Vizualizare fisiere";
	std::cout << "\n\t3. Stergere utilizator";
	std::cout << "\n\t4. Promote user";
	std::cout << "\n\t5. Setari cont" << std::endl;
}

void CAdmin::ViewFiles() {
...
void  CAdmin::AskViewFilesDetails() {
...
int CAdmin::getUsers(std::list<std::string>* list_users) {
...
int CAdmin::deleteUser(std::string username) {
...
void CAdmin::AskDeleteUserDetails() {
...
int CAdmin::promoteUser(std::string username, int mod) {
...
void CAdmin::AskPromoteUserDetails() {
	...
	int ret = promoteUser(username, mod);
