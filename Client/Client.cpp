...
void Client::Sockaddr_init()
{
	...
	m_server.sin_addr.s_addr = inet_addr("192.168.0.101");
...
void Client::SwitchSetariCont() {

	system("cls");
	std::cout << "Setari cont\n\n";
...
int Client::SchimbaParola() {
	...
	int ret = changePassword(newPass, oldPass);
